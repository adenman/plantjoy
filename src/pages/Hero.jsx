...
const Hero = () => (
  ...
  >
    ...
    <div className="relative z-10 text-center px-4">
      ...
      <a href="#" className="bg-green-500 text-white font-bold py-4 px-8 rounded-lg shadow-lg hover:bg-green-600 transition-all duration-300 transform hover:scale-105 text-lg">
